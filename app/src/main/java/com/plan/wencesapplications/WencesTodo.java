...
public class WencesTodo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.activity_wences_todo);
        ...
        mainAdapter=new MainAdapter(dataList,WencesTodo.this);
        //set adapter
        ...
        btAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sText.equals("")){
                    ...
                    dataList.clear();
                    Toast.makeText(WencesTodo.this,"Successfully added!",Toast.LENGTH_LONG).show();

                    dataList.addAll(database.mainDao().getAll());
                    mainAdapter.notifyDataSetChanged();

                }else{
                    builder= new AlertDialog.Builder(WencesTodo.this);
